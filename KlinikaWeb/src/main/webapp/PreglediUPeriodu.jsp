...
<title>Prikaz pregleda po periodu</title>
...
<div class="horizontal-nav">
	...
	<br><br><br><br><br>
	<form action="/Klinika/pregledi/PreglediUPeriodu" method="get">
		<table class="tabela-predstojeceZ">
			<tr>
			<th colspan="2">PRIKAZ IZVRSENIH PREGLEDA ZA PERIOD</th>
			</tr>
			<tr>
				<td>Datum od:</td>
				<td><input name="datumOd"></td>
			</tr>
			<tr>
				<td>Datum do:</td>	
				<td><input name="datumDo"></td>
			</tr>
			<tr>
				<td colspan="2"><input type="submit" value="Prikaz"></td>
			</tr>
		</table>
	</form>
