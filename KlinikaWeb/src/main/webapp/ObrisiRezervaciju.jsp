...
<body>
	...
	<br>
	<br>
	<form action="/Klinika/brisanjeRezervacije/obrisi" method="POST"
		class="tabela-predstojeceZZZ">
		<select name="idRezervacije" size="20" class="selectIzmena2">
			<c:forEach items="${rezervacije}" var="r">
				<option value="${r.idRezervacije}">|ID:
					${r.idRezervacije}|${r.datum} - ${r.pacijent.ime}
					${r.pacijent.prezime} kod DR ${r.lekar.prezime}</option>
			</c:forEach>
		</select><br>
		<br> <input type="submit" value="OBRISI">
	</form>
</body>
</html>